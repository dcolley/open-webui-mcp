				...
				>
					<div class="px-1">
						<div class="flex gap-2">
							...
							<Tooltip content="Verify MCP Server" className="self-end -mb-1">
								<button
						...
						<div class="flex gap-2 mt-2">
							...
							<div class="flex flex-col w-full">
								...
								<div class="flex-1">
									<Tooltip
										content={$i18n.t(
											'Prefix ID is used to avoid conflicts with other MCP Servers by adding a prefix to the model IDs - leave empty to disable'
										)}
									>
										<input
											class="w-full text-sm bg-transparent placeholder:text-gray-300 dark:placeholder:text-gray-700 outline-hidden"
