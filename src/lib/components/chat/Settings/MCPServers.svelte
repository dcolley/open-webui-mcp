<script lang="ts">
	...
	import MCPServer from './MCPServers/MCPServer.svelte';
	...
	const addMCPServerHandler = async (connection) => {
...
<AddMCPServerModal direct bind:show={showMCPServerModal} onSubmit={addMCPServerHandler} />
